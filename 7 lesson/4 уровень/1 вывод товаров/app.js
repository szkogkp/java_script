...
var productsCatalog = document.querySelector('.products');
...
function showCategory(category) {
    products[category].forEach(product => productsCatalog.insertAdjacentHTML("beforeend", getProductMarkup(product)));
}
